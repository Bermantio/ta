                    ...
                    <div class="card-body">
                        <form action="{{ route('datanontunai.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="name_zakki" class="form-control">
                                <option value="" selected disableb>-- Pilih Nama --</option>
                                    @foreach ($nontunai as $meili)
                                        <option value="{{ $meili->name_zakki }}">{{ $meili->name_zakki }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">No Telp/HP/WA</label>
                                <input type="text" class="form-control @error('notelepon') is-invalid @enderror" name="notelepon" value="{{ old('notelepon') }}" placeholder="Masukkan No Telp/WA">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="name_program" id="pilih" class="form-control" onchange="GetHarga(this.value)">
                                <option value="" selected disabled>-- Pilih Program --</option>
                                    @foreach ($nontunai as $nikber)
                                        <option value="{{ $nikber->name_program }}">{{ $nikber->name_program }}</option>
                                    @endforeach
                                </select>
                                <div class="text-danger">
                                    @error('name_program')
                            ...
                            <div class="form-group">
                                <label>Berupa</label>
                                <select name="keterangan" class="form-control" value="{{ old('keterangan') }}">
                                <option value="" selected disabled>-- Berupa Sebagai --</option>
