                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input name="nama_kry" class="form-control" value="{{ $karyawan->nama_kry }}">
                            ...
                            <div class="form-group">
                                ...
                                <input name="nohp" class="form-control" value="{{ $karyawan->nohp }}">
                                <div class="text-danger">
                                    @error('nohp')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                <label>Posisi</label>
                                <input name="posisi" class="form-control" value="{{ $karyawan->posisi }}">
                                <div class="text-danger">
                                    @error('posisi')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                <label>Gaji</label>
                                <input name="gaji" id="gaji" class="form-control" value="{{ $karyawan->gaji }}">
                                <div class="text-danger">
                                    @error('gaji')
                                        {{ $message }}
                                    @enderror
