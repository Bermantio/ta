...
<head>
    ...
    <title>Edit Data Penyaluran</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('datapenyaluran.update', $datapenyaluran->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ old('status', $datapenyaluran->status) }}" placeholder="Masukkan Status">
                            </div>
